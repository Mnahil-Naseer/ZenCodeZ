  ...
  return (
    <section id="about-section" className="bg-slate-200 py-12 px-4">
      <div className="container mx-auto">
        <h2 className="text-3xl font-bold mb-16 text-center">About ZenCodeZ</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          <div className="flex justify-center items-center">
            <img src={mission} alt="Company Introduction" className="rounded-full shadow-inner shadow-gray-500 w-96" />
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
        <div className="flex justify-center items-center">
            <img src={vision} alt="Company Introduction" className="rounded-full shadow-inner shadow-gray-500 w-96" />
          </div>
          <div className="flex mb-12 flex-col mx-10">
