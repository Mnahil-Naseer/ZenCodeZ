  ...
  return (
    <section className="bg-slate-200 p-6 md:p-10">
      <div className="container mx-auto">
        <h2 className="text-lg md:text-xl lg:text-2xl font-bold text-cyan-800 mb-4 md:mb-5 lg:mb-6 text-center md:text-left mx-4 md:mx-10">
          Our Services
        </h2>
        <div className="text-2xl md:text-3xl font-bold mb-8 md:mb-12 text-center md:text-left mx-4 md:mx-10">
          We Are Finest At
