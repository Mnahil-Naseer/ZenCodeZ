...
function Header({ isLoggedIn, setIsLoggedIn }) {
  ...
  return (
    <header className="bg-cyan-800  text-white shadow-black shadow-2xl p-2 fixed top-0 w-full z-20 flex justify-between items-center">
      ...
      {/* Sidebar for mobile */}
      <nav className={`fixed top-0 left-0 h-full w-64 bg-cyan-800   text-white transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out md:relative md:translate-x-0 md:flex md:items-center md:w-auto`}>
        ...
        <ul className="mt-12 md:mt-0 flex flex-col md:flex-row  mx-5 font-semibold md:space-x-10 text-lg">
